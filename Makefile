...
build-darwin:
	...
	# set executable icon
	./setIcon.sh Resources/Images/KrankyBearTrapperRedPlaid.png $(BUILD_DIR)/$(BINARY_NAME)-macos-arm64
	./setIcon.sh Resources/Images/KrankyBearTrapperRedPlaid.png $(BUILD_DIR)/$(BINARY_NAME)-macos-amd64
	cp $(BUILD_DIR)/$(BINARY_NAME)-macos-arm64 ./pacman
...
build-windows:
	...
	./setIcon.sh Resources/Images/KrankyBearTrapperRedPlaid.png $(BUILD_DIR)/$(BINARY_NAME)-win-amd64.exe
...
build-windows-webview:
	...
	@echo "       go mod tidy"
	@echo "       go build -tags webview -o pacman-webview.exe"
	@echo ""
...
build-windows-webview-debug:
	...
	@echo "       go build -tags webview -o pacman-webview-debug.exe"
	@echo ""
...
# Show help
help:
	@echo "KrankyBear PacMan - Makefile commands:"
	@echo ""

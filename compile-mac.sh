...
echo "KrankyBear PacMan - macOS Compile Script"
echo "================================================"
echo ""
...
GOOS=darwin GOARCH=amd64 CGO_ENABLED=1 go build -ldflags="-s -w" -trimpath -o bin/pacman-macos-amd64 2>&1
if [ $? -eq 0 ]
then
...
GOOS=darwin GOARCH=arm64 CGO_ENABLED=1 go build -ldflags="-s -w" -trimpath -o bin/pacman-macos-arm64 2>&1
if [ $? -eq 0 ]
then
...
echo "Setting icons"
./setIcon.sh Resources/Images/KrankyBearTrapperRedPlaid.png bin/pacman-macos-amd64
./setIcon.sh Resources/Images/KrankyBearTrapperRedPlaid.png bin/pacman-macos-arm64
